...
const { schema } = require("./member.model");
...
const productSchema = new mongoose.Schema({
    ...
    product_collection: {
        type: String,
        required: true,
        enum: {values: product_collection_enums, message:"{Value} is not among enum values"}  
    },
    product_status: {
        type: String,
        required: false,
        default: "PAUSED",
        enum: {values:product_status_enums, message:"{Value} is not among enum values"}
    },
    product_price: {
        type: Number,
        required: true,
